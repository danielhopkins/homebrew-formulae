class AppleTools < Formula
  ...
  url "https://github.com/danielhopkins/apple-tools/releases/download/v26.916.0/apple-tools-26.916.0.tar.gz"
  sha256 "4cd40b38b1acce0bc452638a996ffd8887bd351d599db819187bd8a0ac0fd2e6"
  license "MIT"
