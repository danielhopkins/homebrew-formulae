class AppleTools < Formula
  ...
  url "https://github.com/danielhopkins/apple-tools/releases/download/v26.916.1/apple-tools-26.916.1.tar.gz"
  sha256 "6a5518ebbdd2b0414a09e9d795054711b444a0414dfc67ff4a1cc65cd2b0d4f2"
  license "MIT"
