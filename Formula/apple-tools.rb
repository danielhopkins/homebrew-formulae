class AppleTools < Formula
  ...
  url "https://github.com/danielhopkins/apple-tools/releases/download/v26.812.0/apple-tools-26.812.0.tar.gz"
  sha256 "5ce16a9e12a2e5b27110bffa6df8b48aaa0f8a1ebbd716960feecd64cdebf9b2"
  license "MIT"
