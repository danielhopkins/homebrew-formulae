class AppleTools < Formula
  ...
  url "https://github.com/danielhopkins/apple-tools/releases/download/v26.812.1/apple-tools-26.812.1.tar.gz"
  sha256 "b886342badf54738cdca714df7dc081d16853168839ba3b29b743ccc3367df78"
  license "MIT"
